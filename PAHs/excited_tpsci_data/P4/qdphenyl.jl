...
ctx = fcidump.read("/Users/ayush/workspace/cmf/project_hessian_debug/ClusterMeanField.jl/examples/PAHs/excited_tpsci_data/P4/qdphenyl-fcidump");
h = ctx["H1"];
g = ctx["H2"];
ecore = ctx["ECORE"];
...
@save "data_cmf_P4.jld2" clusters init_fspace ints d1 e_cmf U 
...
#     e2a = FermiCG.compute_batched_pt2(v0, cluster_ops, clustered_ham, thresh_foi=1e-6, verbose=0)
