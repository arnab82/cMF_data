...
ctx = fcidump.read("/Users/ayush/workspace/cmf/project_hessian_debug/ClusterMeanField.jl/examples/PAHs/excited_tpsci_data/P1/fcidump_4mer");
h = ctx["H1"];
g = ctx["H2"];
ecore = ctx["ECORE"];
...
@save "data_cmf_P1.jld2" clusters init_fspace ints d1 e_cmf U 
