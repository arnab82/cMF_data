...
ctx = fcidump.read("/Users/ayush/workspace/cmf/project_hessian_debug/ClusterMeanField.jl/examples/PAHs/excited_tpsci_data/P5/benz-6-fcidump");
h = ctx["H1"];
g = ctx["H2"];
ecore = ctx["ECORE"];
...
@save "data_cmf_P5.jld2" clusters init_fspace ints d1 e_cmf U 
...
# ci_vector[ref_fock][ClusterConfig([2,1,1,1,1,1])] = [0,1,0,0,0,0,0]
# ci_vector[ref_fock][ClusterConfig([1,2,1,1,1,1])] = [0,0,1,0,0,0,0]
# ci_vector[ref_fock][ClusterConfig([1,1,2,1,1,1])] = [0,0,0,1,0,0,0]
# ci_vector[ref_fock][ClusterConfig([1,1,1,2,1,1])] = [0,0,0,0,1,0,0]
# ci_vector[ref_fock][ClusterConfig([1,1,1,1,2,1])] = [0,0,0,0,0,1,0]
# ci_vector[ref_fock][ClusterConfig([1,1,1,1,1,2])] = [0,0,0,0,0,0,1]
